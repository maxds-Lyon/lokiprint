...
#let minor-second-scale   = size-scale.with(ratio: 1.067)
#let major-second-scale   = size-scale.with(ratio: 1.125)
#let minor-third-scale    = size-scale.with(ratio: 1.200)
#let major-third-scale    = size-scale.with(ratio: 1.250)
#let perfect-fourth-scale = size-scale.with(ratio: 1.333)
